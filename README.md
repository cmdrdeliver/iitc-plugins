...
| [discord-portal-link](discord-portal-link/) | Adds a Discord-icon button to the portal details panel. Popup menu copies either a short bold markdown link or a full multi-line readout (owner, resonators, mods, and IITC-computed mod effects) — both with embed suppression and faction-coloured agent names. | [Install](https://raw.githubusercontent.com/cmdrdeliver/iitc-plugins/main/discord-portal-link/discord-portal-link.user.js) |
